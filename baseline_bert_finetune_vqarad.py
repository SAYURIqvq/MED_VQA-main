...
MAX_ANSWERS = 300
MAX_Q_LEN = 32
OUTPUT_DIR = "./vqa_baseline_bert_finetune"
...
class VQABertBaseline(nn.Module):
    def __init__(self, num_classes, freeze_cnn=True, freeze_bert=False):
        super().__init__()
...
def evaluate(model, data_loader, id2answer):
    ...
    print("\n====== Baseline-BERT (finetune) evaluation result ======")
...
def train_baseline_bert_finetune():
    ...
    model_path = os.path.join(OUTPUT_DIR, "vqa_baseline_bert_finetune.pt")
    ...
    print("answer2id save:", mapping_path)


if __name__ == "__main__":
    train_baseline_bert_finetune()
